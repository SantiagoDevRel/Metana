...
function Tab2() {
  ...
  const forgeNow = async (event) => {
    ...
    const resultTx = await forgeTokens(arrTokenIds, arrQuantityToMint);
    setSuccess(resultTx);
    ...
    <>
      <div className={styles.main}>
        <form className={styles.form} onSubmit={forgeNow}>
          <label>
            Check the box of the tokens you want to forge (same quantity for all
            of them)
          </label>
          <div>
          ...
          <button type="submit" className={styles.buttonFurge}>
            Furge tokens
          </button>
        </form>
        <div className={styles.guide}>
          <h4>Forging Guide</h4>
          <p>
            • burn token 0 + burn token 1 = <b>Token 3</b>
          </p>
          <p>
            • burn token 1 + burn token 2 = <b>Token 4</b>
          </p>
          <p>
            • burn token 0 + burn token 2 = <b>Token 5</b>
          </p>
          <p>
            • burn token 0 + burn token 1 + burn token 2 = <b>Token 6</b>
          </p>
          <p>
            • burn token 3, 4, 5 or 6 = <b>Nothing</b>
          </p>
        </div>
      </div>
    </>
